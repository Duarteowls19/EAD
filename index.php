            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <?php if(!$_SESSION['admin'] || $_SESSION['admin'] == 0){ ?>
                            <li class="header-notification">
                                <a href="#!">
                                    <i class="ti-money"></i>
                                    <span class="badge bg-c-pink"></span> <?php echo number_format($user['creditos'], 2, ',','.'); ?>
                                </a>
                            </li>
                            <?php } ?>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <?php if(!isset($_SESSION['admin']) || $_SESSION['admin'] == 0){ ?>
                            ...
                            <?php } else { ?>
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.navigation">ADM</div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="index.php?p=relatorio">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">relatorio</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
